...
### Vertical Reading bei Sprachmodellen: Ein Kategorienfehler

Bei klassischen Quellen (Websites, Organisationen) ist Vertical Reading bloss ineffektiv: Die Quelle kontrolliert ihre Selbstdarstellung.

Bei Sprachmodellen ist es ein **Kategorienfehler**. Fragen wie "Bist du sicher?" oder "Kannst du das überprüfen?" setzen voraus, dass das Modell seine Aussagen mit der Realität vergleichen kann. Das kann es nicht. Es generiert Text basierend auf dem Kontext, ohne Zugang zu einer externen Wahrheit.
...
**Fazit:** Nachfragen beim Sprachmodell ist keine Verifikationsstrategie. Es ist mehr Textgenerierung.
