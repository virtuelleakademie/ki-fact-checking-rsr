...
A Quarto website for a 40-minute workshop on "Lateral Reading" – teaching participants how to fact-check AI outputs. Content is in German, targeting administrative staff at Swiss universities.
...
- `workshop/` – Workshop content sections (framing, experiment-1, experiment-2, lateral-reading, entscheidungsregel)
- `handout.qmd` – Printable quick reference card
